    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item" data-bs-bs-interval="1000">
        ...
        <div class="carousel-caption d-none d-md-block"  style="position: absolute; top: 0; left: 100px; right: 0; text-align: center; padding: 20px;">
          ...
          <p style="text-align: justify; max-width: 600px; margin: 20px auto;">La plataforma de autoevaluación esta diseñada para monitorear y mejorar el cumplimiento 
      ...
      <div class="carousel-item" data-bs-bs-interval="3000">
        ...
        <div class="carousel-caption d-none d-md-block"  style="position: absolute; top: 0; left: 100px; right: 0; text-align: center; padding: 20px;">
          ...
          <p style="text-align: justify; max-width: 600px; margin: 20px auto;">La plataforma permite la supervisión y evaluación de las organizaciones de salud asignadas. 
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleDark" data-bs-slide="next">
    ...
    <section class="py-5 text-center container">
      <div class="row py-lg-5">
        ...
        <p>Por la cual se definen los procedimientos y condiciones de inscripción de los prestadores
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-12 text-col col-lg-6">
                    <p class="mbr-text align-left mbr-fonts-style mb-0 display-7" style="margin-top: 4%;">Servicios con los que cuentan las entidades de salud:<br></p>
                    <ol class="list-group-numbered" style="text-align: justify; padding-left: 10%; margin-top: 2%;">
    ...
    <section class="headers1 cid-svGO3o7YHJ" id="header01-0" style="background-color: white;">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-12 text-col col-lg-6">
                    <p class="mbr-text align-left mbr-fonts-style mb-0 display-7" style="margin-top: 4%;">Se presentan los estándares con los que cada servicio cuenta:<br></p>
                    <ol class="list-group-numbered" style="text-align: justify; padding-left: 10%; margin-top: 2%;">
    ...
    <section class="headers1 cid-svGO3o7YHJ" id="header01-0" style="background-color: #f0f0f0; padding-bottom: 30px;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-12 col-lg-5 title-col" style="text-align: justify;">
                    <h6 class="mbr-section-subtitle align-left mbr-fonts-style my-3 display-1"><strong>Criterios</strong></h6>
                </div>
                <div class="col-12 col-md-12 text-col col-lg-6">
                    <p class="mbr-text align-left mbr-fonts-style mb-0 display-7" style="margin-top: 4%;">Los criterios son los preceptos o indicadores
