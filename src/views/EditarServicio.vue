        ...
        <tr v-for="servicio in servicios" :key="servicio.id">
          ...
          <td>
            <div class="btn-group" role="group" aria-label="">
              <button type="button" v-on:click="mostrarFormularioDeEdicion(servicio)" class="btn btn" style="background-color: #117981; color: #F0F0F0; border-top-right-radius:.3rem; border-bottom-right-radius: .3rem;">Editar</button>
              &nbsp;
